		...
		<div class="col-md-7 sellpost col-md-offset-1">
			<form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" value="<?php echo "$display->judul"; ?>" id="inputjudul" name="judul">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					    <div class="input-group date form_datetime col-md-6" data-date="2015-09-16T05:25:07Z" data-date-format="yyyy-mm-dd hh:ii" data-link-field="dtp_input1">
		                    <input class="form-control" size="18" type="text" value="<?php echo "$display->tanggal"; ?>" readonly name="tanggal">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputhrg" name="harga" value="<?php echo "$display->harga"; ?>">
					</div>
				</div>
				<div class="form-group">
					<label for="inputkota" class="col-sm-2 control-label">Kota</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputkota" name="alamat" value="<?php echo "$display->alamat"; ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" id="inputdes" name="deskripsi"><?php echo "$display->deskripsi"; ?></textarea>
					</div>
				</div>
				<div class="form-group">
